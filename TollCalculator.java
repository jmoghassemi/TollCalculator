...
// The TollCalculator class which calculates the fee for any type of Vehicle (Car/MotorBike), taking into consideration day/evening
// rush hour periods, Weekends, and regular hours. When the fee calculating process for a certain period of time is complete,
// objects of this class will return an int (totalFee), which represents the tax accumulated by the Vehicle passed in as input.
