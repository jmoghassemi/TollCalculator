...
public class Main {
    public static void main(String[] args) {
        ...
        int firstCalculatedFee = tollCalculatorObj.getTollFee(car, LDT1); //Expected value =
        int expected1 = 18 + 18 + 11 + 11 + 11 + 11;
        System.out.println("Toll fee calculated by program= " + firstCalculatedFee); //output =
        System.out.println("Expected output= " + expected1 + "\n");

        int secondCalculatedFee = tollCalculatorObj.getTollFee(car, LDT2); //Expected value =
        int expected2 = 11 + 11 + 11 + 11 + 11;
        System.out.println("Toll fee calculated by program= " + secondCalculatedFee); //output =
        System.out.println("Expected output= " + expected2 + "\n");

        int thirdCalculatedFee = tollCalculatorObj.getTollFee(car, LDT3); //Expected value
        int expected3 = 0 + 0 + 0;
        System.out.println("Toll fee calculated by program= " + thirdCalculatedFee); //output =
        ...
        int fourthCalculatedFee = tollCalculatorObj.getTollFee(mB, LDT4); //Expected value =
        int expected4 = 18 + 8 + 8 + 18 + 8;
        System.out.println("Toll fee calculated by program=" + fourthCalculatedFee); //output =
        System.out.println("Expected output= " + expected4 + "\n");

        int fifthCalculatedFee = tollCalculatorObj.getTollFee(mB, LDT5); //Expected value =
        int expected5 = 8 + 8 + 8 + 8 + 8;
        System.out.println("Toll fee calculated by program=" + fifthCalculatedFee); //output =
        System.out.println("Expected output= " + expected5 + "\n");

        int sixthCalculatedFee = tollCalculatorObj.getTollFee(mB, LDT6); //Expected value =
        int expected6 = 0 + 0 + 0 + 0;
        System.out.println("Toll fee calculated by program=" + sixthCalculatedFee); //output =
